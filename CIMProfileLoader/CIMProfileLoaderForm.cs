    ...
    public partial class CIMProfileLoaderForm : Form
    {
        ...
        private void LoadCIMRDFSFile()
        {
            ...
            try
            {
                ...
                Klasa.Text = profile.BrojKlasa.ToString();
                Atribut.Text = profile.BrojAtributa.ToString();
            }
            catch (Exception e)
            {
        ...
        private void Atribut_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
